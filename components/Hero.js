                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 sm:grid-rows-1 h-2/3 w-full p-3">
                        ...
                        <div className="sm:self-center gap-2 space-y-2">
                            ...
                            <p className="text-3xl text-center sm:text-left">
                                Software Engineer at <a className="underline transition font-bold text-sky-800 hover:text-white" href="https://capitalone.co.uk">Capital One UK</a>
                            </p>
                            <p className="text-2xl text-center sm:text-left">
                                Graduate from the <a className="underline transition font-bold text-sky-800 hover:text-white" href="https://nottingham.ac.uk">University of Nottingham</a>
                            </p>
                            <SocialIcons/>
                        </div>
                    </div>
